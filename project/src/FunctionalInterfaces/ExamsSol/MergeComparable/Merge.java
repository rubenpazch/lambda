package FunctionalInterfaces.ExamsSol.MergeComparable;
import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import FunctionalInterfaces.ExamsSol.GenericExamples.BiComparator;
...
public class Merge {
	...
	public static <T,R>List<? super Comparable<T>> merge(List<T> list1,List<R> list2, BiComparator<T, R> comparator) {
