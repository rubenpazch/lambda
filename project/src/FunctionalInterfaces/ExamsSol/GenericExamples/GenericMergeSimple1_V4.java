...
public class GenericMergeSimple1_V4 {
	public static <T,S> List<?> merge(List<? extends T> list1, List<? extends S> list2,BiComparator<T, S> comparator) {
		//List<? extends Object>
	...
	public static void main(String[] args) {
		...
		System.out.println(GenericMergeSimple1_V4.<String, Employee>merge(strlist1, managerList, comp1));
	}
